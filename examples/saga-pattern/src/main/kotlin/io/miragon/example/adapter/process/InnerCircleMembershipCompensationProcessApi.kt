...
object InnerCircleMembershipCompensationProcessApi {
  val PROCESS_ID: ProcessId = ProcessId("inner-circle-membership-compensation")
  ...
  object Elements {
    ...
    val EVENT_COMPENSATE_CLAIM: ElementId = ElementId("event_compensateClaim")
  ...
  object ServiceTasks {
    ...
    const val MEMBERSHIP_REVOKE_CLAIM: String = "membership.revokeClaim"
  ...
  object Relations {
    ...
    val EVENT_COMPENSATE_CLAIM: BpmnRelations = BpmnRelations(
          name = "Compensate claim",
    ...
    val SERVICE_TASK_CLAIM_MEMBERSHIP: BpmnRelations = BpmnRelations(
          ...
          parentId = null,
          attachedToRef = null,
          attachedElements = listOf("event_compensateClaim"),
